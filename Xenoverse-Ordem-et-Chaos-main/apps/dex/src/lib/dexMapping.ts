/**
 * Maps Xenoverse species IDs to National Pokédex numbers
 * Used for PokeAPI CDN fallback when local sprites are missing
 */

// Comprehensive mapping of species ID to National Dex number
// Covers Gens 1-9 (898 main + some forms)
export const SPECIES_TO_DEX: Record<string, number> = {
    // Gen 1 (001-151)
    ...
    'NIDORANFE': 29, 'NIDORINA': 30, 'NIDOQUEEN': 31,
    'NIDORANMA': 32, 'NIDORINO': 33, 'NIDOKING': 34,
    ...
    'COMFEY': 764,
    'ORANGURU': 765, 'PASSIMIAN': 766,
    'WIMPOD': 767, 'GOLISOPOD': 768,
    'SANDYGAST': 769, 'PALOSSAND': 770,
    'PYUKUMUKU': 771,
    'TYPENULL': 772, 'SILVALLY': 773,
    'MINIOR': 774,
    'KOMALA': 775,
    'TURTONATOR': 776,
    'TOGEDEMARU': 777,
    ...
    'DRAMPA': 780,
    'DHELMISE': 781,
    'JANGMOO': 782, 'HAKAMOO': 783, 'KOMMOO': 784,
    'TAPUKOKO': 785, 'TAPULELE': 786, 'TAPUBULU': 787, 'TAPUFINI': 788,
    'COSMOG': 789, 'COSMOEM': 790, 'SOLGALEO': 791, 'LUNALA': 792,
    'NIHILEGO': 793, 'BUZZWOLE': 794, 'PHEROMOSA': 795, 'XURKITREE': 796,
    'CELESTEELA': 797, 'KARTANA': 798, 'GUZZLORD': 799,
    'NECROZMA': 800,
    'MAGEARNA': 801,
    'MARSHADOW': 802,
    ...
    'SMOLIV': 928, 'DOLLIV': 929, 'ARBOLIVA': 930,
    'SQUAWKABILLY': 931,
    ...
    'WOCHIEN': 1001, 'CHIENPAO': 1002, 'TINGLU': 1003, 'CHIYU': 1004,
    'ROARINGMOON': 1005, 'IRONVALIANT': 1006,
    ...
    'ARCHALUDON': 1018,
    'HYDRAPPLE': 1019,
    'GOUGINGFIRE': 1020, 'RAGINGBOLT': 1021,
    'IRONBOULDER': 1022, 'IRONCROWN': 1023,
    'TERAPAGOS': 1024,
    'PECHARUNT': 1025,
};

/**
 * Get the National Pokédex number for a species ID
 * @param speciesId The Xenoverse species ID (case-insensitive)
 * @returns The National Dex number, or null if not found (e.g., Xenoverse-exclusive)
 */
export function getDexNumber(speciesId: string): number | null {
    if (!speciesId) return null;
    return SPECIES_TO_DEX[speciesId.toUpperCase()] ?? null;
}

/**
 * Get the PokeAPI sprite URL for a species
 * @param speciesId The Xenoverse species ID
 * @returns The PokeAPI CDN URL, or null if not a standard Pokémon
 */
export function getPokeAPISpriteUrl(speciesId: string): string | null {
    const dexNum = getDexNumber(speciesId);
